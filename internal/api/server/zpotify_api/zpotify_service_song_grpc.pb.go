...
func (c *songAPIClient) BatchCreateSong(ctx context.Context, in *BatchCreateSong_Request, opts ...grpc.CallOption) (*BatchCreateSong_Response, error) {
	...
	err := c.cc.Invoke(ctx, SongAPI_BatchCreateSong_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *songAPIClient) GetSong(ctx context.Context, in *GetSong_Request, opts ...grpc.CallOption) (*GetSong_Response, error) {
	...
	err := c.cc.Invoke(ctx, SongAPI_GetSong_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *songAPIClient) SendSongToTelegram(ctx context.Context, in *SendSongToTelegram_Request, opts ...grpc.CallOption) (*SendSongToTelegram_Response, error) {
	...
	err := c.cc.Invoke(ctx, SongAPI_SendSongToTelegram_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *songAPIClient) SearchSongs(ctx context.Context, in *SearchSongs_Request, opts ...grpc.CallOption) (*SearchSongs_Response, error) {
	...
	err := c.cc.Invoke(ctx, SongAPI_SearchSongs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSongAPIServer) BatchCreateSong(context.Context, *BatchCreateSong_Request) (*BatchCreateSong_Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchCreateSong not implemented")
}
...
func (UnimplementedSongAPIServer) SendSongToTelegram(context.Context, *SendSongToTelegram_Request) (*SendSongToTelegram_Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendSongToTelegram not implemented")
}
