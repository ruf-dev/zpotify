...
func (x *Version) Reset() {
	*x = Version{}
	mi := &file_zpotify_service_api_proto_msgTypes[0]
...
func (*Version) Descriptor() ([]byte, []int) {
	return file_zpotify_service_api_proto_rawDescGZIP(), []int{0}
}
...
func (x *Version_Request) Reset() {
	*x = Version_Request{}
	mi := &file_zpotify_service_api_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Version_Request) Descriptor() ([]byte, []int) {
	return file_zpotify_service_api_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Version_Response) Reset() {
	*x = Version_Response{}
	mi := &file_zpotify_service_api_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Version_Response) Descriptor() ([]byte, []int) {
	return file_zpotify_service_api_proto_rawDescGZIP(), []int{0, 1}
}
...
var (
	...
	file_zpotify_service_api_proto_rawDescData []byte
)

func file_zpotify_service_api_proto_rawDescGZIP() []byte {
	file_zpotify_service_api_proto_rawDescOnce.Do(func() {
		file_zpotify_service_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_zpotify_service_api_proto_rawDesc), len(file_zpotify_service_api_proto_rawDesc)))
	})
	return file_zpotify_service_api_proto_rawDescData
}

var file_zpotify_service_api_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_zpotify_service_api_proto_goTypes = []any{
...
func file_zpotify_service_api_proto_init() {
	if File_zpotify_service_api_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_zpotify_service_api_proto_rawDesc), len(file_zpotify_service_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_zpotify_service_api_proto_goTypes,
		DependencyIndexes: file_zpotify_service_api_proto_depIdxs,
		MessageInfos:      file_zpotify_service_api_proto_msgTypes,
	}.Build()
	File_zpotify_service_api_proto = out.File
	file_zpotify_service_api_proto_goTypes = nil
	file_zpotify_service_api_proto_depIdxs = nil
}
