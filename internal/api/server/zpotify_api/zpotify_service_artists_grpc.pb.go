...
func (c *artistsAPIClient) ListArtist(ctx context.Context, in *ListArtist_Request, opts ...grpc.CallOption) (*ListArtist_Response, error) {
	...
	err := c.cc.Invoke(ctx, ArtistsAPI_ListArtist_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *artistsAPIClient) CreateArtist(ctx context.Context, in *CreateArtist_Request, opts ...grpc.CallOption) (*CreateArtist_Response, error) {
	...
	err := c.cc.Invoke(ctx, ArtistsAPI_CreateArtist_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *artistsAPIClient) LikeArtist(ctx context.Context, in *LikeArtist_Request, opts ...grpc.CallOption) (*LikeArtist_Response, error) {
	...
	err := c.cc.Invoke(ctx, ArtistsAPI_LikeArtist_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *artistsAPIClient) UnlikeArtist(ctx context.Context, in *UnlikeArtist_Request, opts ...grpc.CallOption) (*UnlikeArtist_Response, error) {
	...
	err := c.cc.Invoke(ctx, ArtistsAPI_UnlikeArtist_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *artistsAPIClient) GetArtistPage(ctx context.Context, in *GetArtistPage_Request, opts ...grpc.CallOption) (*GetArtistPage_Response, error) {
	...
	err := c.cc.Invoke(ctx, ArtistsAPI_GetArtistPage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *artistsAPIClient) UpdateArtist(ctx context.Context, in *UpdateArtist_Request, opts ...grpc.CallOption) (*UpdateArtist_Response, error) {
	...
	err := c.cc.Invoke(ctx, ArtistsAPI_UpdateArtist_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedArtistsAPIServer must be embedded to have forward compatible implementations.
...
func (UnimplementedArtistsAPIServer) GetArtistPage(context.Context, *GetArtistPage_Request) (*GetArtistPage_Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetArtistPage not implemented")
}
