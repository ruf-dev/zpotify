...
func (c *searchAPIClient) Search(ctx context.Context, in *Search_Request, opts ...grpc.CallOption) (*Search_Response, error) {
	...
	err := c.cc.Invoke(ctx, SearchAPI_Search_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSearchAPIServer must be embedded to have
...
func (UnimplementedSearchAPIServer) testEmbeddedByValue()                   {}
...
func RegisterSearchAPIServer(s grpc.ServiceRegistrar, srv SearchAPIServer) {
	// If the following call panics, it indicates UnimplementedSearchAPIServer was
