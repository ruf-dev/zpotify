...
type AuthAPIClient interface {
	...
	AuthAsync(ctx context.Context, in *AuthViaAsync_Request, opts ...grpc.CallOption) (AuthAPI_AuthAsyncClient, error)
...
func (c *authAPIClient) GetAuthMethods(ctx context.Context, in *GetAuthMethods_Request, opts ...grpc.CallOption) (*GetAuthMethods_Response, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_GetAuthMethods_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authAPIClient) Auth(ctx context.Context, in *Auth_Request, opts ...grpc.CallOption) (*Auth_Response, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_Auth_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authAPIClient) AuthAsync(ctx context.Context, in *AuthViaAsync_Request, opts ...grpc.CallOption) (AuthAPI_AuthAsyncClient, error) {
	stream, err := c.cc.NewStream(ctx, &AuthAPI_ServiceDesc.Streams[0], AuthAPI_AuthAsync_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &authAPIAuthAsyncClient{stream}
...
type AuthAPI_AuthAsyncClient interface {
	Recv() (*AuthViaAsync_Response, error)
	grpc.ClientStream
}

type authAPIAuthAsyncClient struct {
	grpc.ClientStream
}

func (x *authAPIAuthAsyncClient) Recv() (*AuthViaAsync_Response, error) {
	m := new(AuthViaAsync_Response)
...
func (c *authAPIClient) RefreshToken(ctx context.Context, in *Refresh_Request, opts ...grpc.CallOption) (*Refresh_Response, error) {
	...
	err := c.cc.Invoke(ctx, AuthAPI_RefreshToken_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthAPIServer interface {
	...
	AuthAsync(*AuthViaAsync_Request, AuthAPI_AuthAsyncServer) error
...
func (UnimplementedAuthAPIServer) AuthAsync(*AuthViaAsync_Request, AuthAPI_AuthAsyncServer) error {
	return status.Errorf(codes.Unimplemented, "method AuthAsync not implemented")
}
...
func _AuthAPI_AuthAsync_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(AuthAPIServer).AuthAsync(m, &authAPIAuthAsyncServer{stream})
}

type AuthAPI_AuthAsyncServer interface {
	Send(*AuthViaAsync_Response) error
	grpc.ServerStream
}

type authAPIAuthAsyncServer struct {
	grpc.ServerStream
}

func (x *authAPIAuthAsyncServer) Send(m *AuthViaAsync_Response) error {
