...
func (c *zpotifyAPIClient) Version(ctx context.Context, in *Version_Request, opts ...grpc.CallOption) (*Version_Response, error) {
	...
	err := c.cc.Invoke(ctx, ZpotifyAPI_Version_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedZpotifyAPIServer must be embedded to have forward compatible implementations.
...
var ZpotifyAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "zpotify_service_api.proto",
}
