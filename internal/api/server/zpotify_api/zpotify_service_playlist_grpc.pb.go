...
func (c *playlistAPIClient) AddSongToPlaylist(ctx context.Context, in *AddSongToPlaylist_Request, opts ...grpc.CallOption) (*AddSongToPlaylist_Response, error) {
	...
	err := c.cc.Invoke(ctx, PlaylistAPI_AddSongToPlaylist_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *playlistAPIClient) ListPlaylists(ctx context.Context, in *ListPlaylists_Request, opts ...grpc.CallOption) (*ListPlaylists_Response, error) {
	...
	err := c.cc.Invoke(ctx, PlaylistAPI_ListPlaylists_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
